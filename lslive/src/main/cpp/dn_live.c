...
#define LOGI(FORMAT,...) __android_log_print(ANDROID_LOG_INFO,"x264",FORMAT,##__VA_ARGS__)
#define LOGE(FORMAT,...) __android_log_print(ANDROID_LOG_ERROR,"x264",FORMAT,##__VA_ARGS__)
